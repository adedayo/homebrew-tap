...
class Tlsaudit < Formula
  ...
  if OS.mac?
    url "https://github.com/adedayo/tlsaudit/releases/download/v0.7.0/tlsaudit_0.7.0_Darwin_x86_64.tar.gz"
    sha256 "2dc6310f5fc37f0ac977ff7c954a21fcc613baf58b6bdff4f2066b28b5869644"
  elsif OS.linux?
  end
